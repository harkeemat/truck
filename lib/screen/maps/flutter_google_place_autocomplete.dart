...
import 'package:truck/screen/maps/google_place_util.dart';
...
/*adding to previous value as done in encoding */
  ...
  void sendRequest(String intendedLocation) async {
    List<Location> placemark = await locationFromAddress('suratgarh');
    print(placemark);
    double latitude = placemark[0].latitude;
    double longitude = placemark[0].longitude;
    LatLng destination = LatLng(30.733315, 76.779419);
